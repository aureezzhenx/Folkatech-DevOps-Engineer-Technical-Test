...
Menggunakan Terraform sebagai Infrastuktur As Code untuk meng-instalasi instance t2.small ap-southeast-3 di VPC baru dengan security group port SSH hanya bisa diakses oleh IP tertentu (alasan keamanan), melakukan konfigurasi auto scalling Amazon Load Balancer terhadap server frontend dengan max_size 4
